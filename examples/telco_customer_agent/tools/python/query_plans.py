"""Query available telco plans from the local SQLite database."""
...
@tool
def query_plans(sql_query: str) -> str:
    """
    Execute a SQL query against the plans table in the telco database.

    :param sql_query: A valid SQLite SELECT statement to run against the plans table.
